...
export default async function AdminReportsPage() {
  ...
  // Payment summary per ekskul (LUNAS only)
  ...
  const ekskuls = [...recap.keys()];
  ekskuls.sort();

  const studentAttendance = await getAttendanceByStudent();

  return (
    <div>
      <PageHeader
        title="Rekap & Laporan"
        description="Ringkasan kehadiran dan pembayaran per ekstrakurikuler."
        actions={
